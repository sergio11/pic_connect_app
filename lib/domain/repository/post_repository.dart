...
abstract class PostRepository {
  ...
  Future<Either<Failure, List<PostBO>>>
      findPicturesByUserUidOrderByDatePublished(String userUi);
  ...
  Future<Either<Failure, List<PostBO>>>
      findAllFavoritesByUserUidOrderByDatePublished(String userUi);

  Future<Either<Failure, List<PostBO>>>
      findAllBookmarkByUserUidOrderByDatePublished(String userUi);

  Future<Either<Failure, List<PostBO>>>
      findAllByUserUidListOrderByDatePublished(List<String> userUidList);
